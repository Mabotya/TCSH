...
Unauthorized uploading, redistribution, and modification of TCSH's original components are prohibited.
Third-party software bundled with TCSH is governed by its respective license. FFmpeg is provided under the GNU Lesser General Public License version 2.1 or later.
